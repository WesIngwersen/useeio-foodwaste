...
ROOT_URLCONF = 'useeio_foodwaste.urls'
APPEND_SLASH = False
...
WSGI_APPLICATION = 'useeio_foodwaste.wsgi.application'
# Database
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'useeio_foodwaste', 'static')
