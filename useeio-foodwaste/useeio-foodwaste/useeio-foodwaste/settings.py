...
ROOT_URLCONF = 'useeio-foodwaste.urls'
APPEND_SLASH = False
...
WSGI_APPLICATION = 'useeio-foodwaste.wsgi.application'
# Database
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'useeio-foodwaste', 'static')

DOWNLOADS_DIR = os.path.join("..", "docs")
MANUAL_NAME = 'K-LRTD-0032360-QM-1-0.docx'
# EXCEL_TOOL = ''

MEDIA_ROOT = os.path.join(BASE_DIR, "useeio-foodwaste/media")
MEDIA_URL = "/media/"
